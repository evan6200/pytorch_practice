...
net = net_test1(initial_num_channels=19,num_classes=7,num_channels=64)
print ('net',net)
net.to(device)
...
total_test_object_count=len(x0_test)

x1_test=torch.zeros(total_test_object_count,feature_size,feature_size)
for i,data in enumerate(x_test):
    for j,data0 in enumerate(data):
        x1_test[i][j]=x_test[i][j]
...
for epoch in range(800):
    ...
    print('Evan print TEST ACC',ave_test_acc)
