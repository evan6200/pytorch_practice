...
final_demo_test='/home/evan/512_DISK/train_sample_7person/keypoints_P8_P16/22P_MOD20_DEMO/'

#0611 all point with demo
#training sample
training_keypoint=final_demo_test
#test sample
#3M
...
#            print nose
            ...
            #fake feature test fake point
            fake_feature_point1=[gravityXY[0],gravityXY[1]+get_dist(neck,mhip)]
            fake1=get_feature( fake_feature_point1,rknee)
            fake2=get_feature( fake_feature_point1,lknee)
            fake3=get_feature( fake_feature_point1,rshoulder)
            fake4=get_feature( fake_feature_point1,lshoulder)
...
#            lag_heelR=get_feature(rhip,rheel)
            ...
            #test fake point
            all_feature=np.concatenate((all_feature,fake1),axis=0)
            all_feature=np.concatenate((all_feature,fake2),axis=0)
            all_feature=np.concatenate((all_feature,fake3),axis=0)
            all_feature=np.concatenate((all_feature,fake4),axis=0)        
...
#    out_all_ERR=dataE
    ...
    if acc > 0.84 and  train_acc > 0.90:
        break
