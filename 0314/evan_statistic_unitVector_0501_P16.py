...
pic_location='report_0506'

from gen_statistic_0501 import get_TESTER_data
import gen_statistic_0501

xS,yS=gen_statistic_0501.get_TESTER_data() # x,y for statistic.
CLASSES=7
...
def print_meter_rate(in_data):
    ...
    for i in range (9): #9M
      Px=0
      tmp=[]
      for j in range(i,81,9): #0501 modified 63 ->81
