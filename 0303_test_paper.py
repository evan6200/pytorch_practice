...
#training sample
keypoint_video="/home/evan/mp4_to_png/6m_train_data/save_video_p1/keypoint_all/"
#test sample
keypoint_video_P3TEST="/home/evan/mp4_to_png/6m_train_data/save_video_p3/keypoint_all_P3TEST/"

keypoint_video_9m_P1TEST="/home/evan/mp4_to_png/9m_train_data/save_video_p1/keypoint_all_P1TEST/"
...
#test keypoint_video_6mP1_P2_3mP1, keypoint_video_9m_P1TEST = 70%
#0303
#training sample
#training_keypoint="/home/evan/mp4_to_png/mix_3M_6M9M/3P1_6P1_P2_9P1_P2/keypoint_mix/"
training_keypoint=k_MIX_3P1_6P1P2
#test sample
#3M
...
#    out_all_ERR=dataE
    ...
    if acc>0.74 and ave_loss < 0.1 and train_acc > 0.98:
        break
torch.save(net,"0303_6P12.pkl")
plt.savefig("PIC_0303_6P12.jpg")
