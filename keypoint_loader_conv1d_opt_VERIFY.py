...
#training sample
keypoint_video="/home/evan/mp4_to_png/9m_train_data/save_video_p1/keypoint_all/"
#test sample
keypoint_video_P3TEST="/home/evan/mp4_to_png/9m_train_data/save_video_p3/keypoint_all_P3TEST/"

keypoint_video_12m_P1TEST="/home/evan/mp4_to_png/12m_train_data/save_video_p1/keypoint_all_P1TEST/"

#9m P2
keypoint_video_9m_P2TEST="/home/evan/mp4_to_png/9m_train_data/save_video_p2/keypoint_all_P2TEST/"

keypoint_video_9mP1_P2="/home/evan/mp4_to_png/9m_train_data/keypoint_p1_p3/"

#train=9m P1 P2
keypoint_video=keypoint_video_9mP1_P2
#keypoint_video=keypoint_video_9m_P2TEST
#test=12m P1
keypoint_video_P3TEST=keypoint_video_12m_P1TEST


#keypoint_video_P3TEST=keypoint_video

files_TEST=[name for name in os.listdir(keypoint_video_P3TEST)]
files_TEST.sort()

files=[name for name in os.listdir(keypoint_video)]
files.sort()
...
#            print nose
            ...
            d_rheel=get_dist(gravityXY,rheel)/get_dist(neck,mhip)
            #total 19 feature
            x0.append([d_neck,d_rshoulder,d_lshoulder,d_mhip,d_rhip,d_rknee,d_rankle,d_lhip,d_lknee,d_lankle,d_lbigtoe,d_lsmalltoe,d_lheel,d_rbigtoe,d_rsmalltoe,d_rheel,d_rbigtoe,d_rsmalltoe,d_rheel])
...
net = SoftMax(initial_num_channels=19,num_classes=7,num_channels=64)
print ('net',net)
net.to(device)
...
x0,y0= read_data(files,keypoint_video) #training sample
x0_test,y0_test=read_data(files_TEST,keypoint_video_P3TEST)

x=tensor.new_tensor(x0)
y=tensor2.new_tensor(y0)
...
#setup test data
x_test=tensor.new_tensor(x0_test)
y_test=tensor2.new_tensor(y0_test)

total_object_count=list(x_test.size())[0]
feature_size=list(x_test.size())[1]
...
for epoch in range(800):
    ...
    for batch_x, batch_y in loader:
        ...
        _, real_label = torch.max(batch_y.data,1)
...
#    out_all_ERR=dataE
    ...
    if acc>0.74 and ave_loss < 0.1 and train_acc > 0.98:
        break
torch.save(net,"1213_9m_P1_P2.pkl")
plt.savefig("PIC_9m_P1_P2_test_12mP1.jpg")
